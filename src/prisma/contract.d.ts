...
export type StorageHash =
  StorageHashBase<'55cfb3d77a0d8966d5e12b5a9d4066926ee7b392e0d4c0d7bd43cd9bdaaabed1'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly DecisionStatusHistory: {
      readonly id: CodecTypes['pg/int4@1']['output'];
      readonly previousStatus: 'PROPOSED' | 'ACCEPTED' | 'REJECTED' | 'SUPERSEDED';
      readonly newStatus: 'PROPOSED' | 'ACCEPTED' | 'REJECTED' | 'SUPERSEDED';
      readonly decisionId: CodecTypes['pg/int4@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly DecisionStatusHistory: {
      ...
      readonly previousStatus: 'PROPOSED' | 'ACCEPTED' | 'REJECTED' | 'SUPERSEDED';
      readonly newStatus: 'PROPOSED' | 'ACCEPTED' | 'REJECTED' | 'SUPERSEDED';
      readonly decisionId: CodecTypes['pg/int4@1']['input'];
...
export namespace Models {
  export type public_User = {
    ...
    activities: public_ActivityLog[];
    decisionChanges: public_DecisionStatusHistory[];
    memberships: public_WorkspaceMember[];
    readonly [RelationKeys]?: 'activities' | 'decisionChanges' | 'memberships';
  };
  export type public_Workspace = {
    ...
    readonly [RelationKeys]?: 'activities' | 'members' | 'projects';
  };
  ...
  export type public_Decision = {
    ...
    statusHistory: public_DecisionStatusHistory[];
    readonly [RelationKeys]?:
      'incomingRelations' | 'outgoingRelations' | 'project' | 'statusHistory';
  };
  ...
  export type public_DecisionStatusHistory = {
    id: CodecTypes['pg/int4@1']['output'];
    previousStatus: 'PROPOSED' | 'ACCEPTED' | 'REJECTED' | 'SUPERSEDED';
    newStatus: 'PROPOSED' | 'ACCEPTED' | 'REJECTED' | 'SUPERSEDED';
    decisionId: CodecTypes['pg/int4@1']['output'];
    changedById: CodecTypes['pg/int4@1']['output'];
    createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
    changedBy: public_User;
    decision: public_Decision;
    readonly [RelationKeys]?: 'changedBy' | 'decision';
  };
...
export declare const models: {
  public: {
    ...
    DecisionStatusHistory: Models.public_DecisionStatusHistory;
          ...
          readonly table: {
            readonly activityLog: {
              ...
              indexes: readonly [
                ...
                {
                  readonly name: 'activityLog_workspaceId_idx_ba65f874';
                  readonly prefix: 'activityLog_workspaceId_idx';
            ...
            readonly decisionStatusHistory: {
              ...
              indexes: readonly [
                {
                  readonly name: 'decisionStatusHistory_decisionId_idx_8a798f77';
                  readonly prefix: 'decisionStatusHistory_decisionId_idx';
                  readonly columns: readonly ['decisionId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'decisionStatusHistory_changedById_idx_d6e6aadb';
                  readonly prefix: 'decisionStatusHistory_changedById_idx';
              ...
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'decisionStatusHistory';
                    readonly columns: readonly ['decisionId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
...
> & {
  ...
  readonly roots: {
    ...
    readonly decisionStatusHistory: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'DecisionStatusHistory';
    };
    readonly activityLog: {
      readonly namespace: 'public' & NamespaceId;
          ...
          readonly Decision: {
            ...
            readonly relations: {
              ...
              readonly statusHistory: {
                ...
                readonly on: {
                  readonly localFields: readonly ['id'];
                  readonly targetFields: readonly ['decisionId'];
                };
              };
            };
            readonly storage: {
          ...
          readonly DecisionStatusHistory: {
            ...
            readonly relations: {
              ...
              readonly decision: {
                ...
                readonly nullable: false;
                readonly on: {
                  readonly localFields: readonly ['decisionId'];
                  readonly targetFields: readonly ['id'];
                };
              };
            };
            readonly storage: {
              readonly table: 'decisionStatusHistory';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly previousStatus: { readonly column: 'previousStatus' };
                readonly newStatus: { readonly column: 'newStatus' };
                readonly decisionId: { readonly column: 'decisionId' };
